...
return new class extends Migration
{
    public function up(): void
    {
        if (DB::getDriverName() === 'sqlite') {
            ...
            Schema::dropIfExists('comments_fixed');
            Schema::dropIfExists('comments_temp');
            Schema::dropIfExists('comments_original');
            ...
            // 2. Переносим данные с правильным преобразованием
